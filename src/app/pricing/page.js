...
const PLANS = [
  { id: 'free', name: 'Free', price: 0, priceId: null,
    ...
    limit: '5 runs' },
  { id: 'starter', name: 'Starter', price: 29, priceId: 'price_1T7PZRHyFx12nKYlKz8Hd9Eh',
  ...
  { id: 'pro', name: 'Pro', price: 79, priceId: 'price_1T7PZcHyFx12nKYlj7ot73AR',
    ...
    limit: 'Unlimited' },
  { id: 'enterprise', name: 'Enterprise', price: 199, priceId: 'price_1T7PZqHyFx12nKYlUmAZGOoq',
